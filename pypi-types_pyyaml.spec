...
Source0  : https://files.pythonhosted.org/packages/92/7d/a95df0a11f95c8f48d7683f03e4aed1a2c0fc73e9de15cca4d38034bea1a/types-PyYAML-6.0.12.20240917.tar.gz
...
%prep
%setup -q -n types-PyYAML-6.0.12.20240917
cd %{_builddir}/types-PyYAML-6.0.12.20240917
pushd ..
cp -a types-PyYAML-6.0.12.20240917 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726559373
