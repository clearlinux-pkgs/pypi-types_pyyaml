...
Source0  : https://files.pythonhosted.org/packages/b5/c4/7d307b64d33f98c18bcddb0ed80d9f19f492cb5a849eb3d23de9555e2ea8/types-PyYAML-6.0.12.20240724.tar.gz
...
%prep
%setup -q -n types-PyYAML-6.0.12.20240724
cd %{_builddir}/types-PyYAML-6.0.12.20240724
pushd ..
cp -a types-PyYAML-6.0.12.20240724 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721836357
