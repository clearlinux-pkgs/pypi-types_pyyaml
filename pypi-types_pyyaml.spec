...
Source0  : https://files.pythonhosted.org/packages/1d/b5/bb2c2541056b26c419ed9ce8635e483257562433026a7174bddd078f665c/types-PyYAML-6.0.8.tar.gz
...
%prep
%setup -q -n types-PyYAML-6.0.8
cd %{_builddir}/types-PyYAML-6.0.8
pushd ..
cp -a types-PyYAML-6.0.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654186772
