...
Source0  : https://files.pythonhosted.org/packages/dd/08/6f5737f645571b7a0b1ebd2fe8b5cf1ee4ec3e707866ca96042a86fc1d10/types-PyYAML-6.0.12.20240808.tar.gz
...
%prep
%setup -q -n types-PyYAML-6.0.12.20240808
cd %{_builddir}/types-PyYAML-6.0.12.20240808
pushd ..
cp -a types-PyYAML-6.0.12.20240808 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723126902
