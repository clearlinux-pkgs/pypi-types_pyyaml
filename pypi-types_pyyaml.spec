...
Source0  : https://files.pythonhosted.org/packages/2b/0d/882d0771996897df176521a93c2ce9d9b0da66d0f9c2bc441b9872a91297/types-PyYAML-6.0.9.tar.gz
...
%prep
%setup -q -n types-PyYAML-6.0.9
cd %{_builddir}/types-PyYAML-6.0.9
pushd ..
cp -a types-PyYAML-6.0.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656344289
