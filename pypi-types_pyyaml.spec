...
Source0  : https://files.pythonhosted.org/packages/6c/f4/65001b471f370ab8cac8a7244e810ddecec2e45213150c60736bf4e806bd/types-PyYAML-6.0.12.3.tar.gz
...
%prep
%setup -q -n types-PyYAML-6.0.12.3
cd %{_builddir}/types-PyYAML-6.0.12.3
pushd ..
cp -a types-PyYAML-6.0.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674057030
