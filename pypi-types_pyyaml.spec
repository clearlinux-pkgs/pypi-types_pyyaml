...
Source0  : https://files.pythonhosted.org/packages/0a/3c/6f4c97d9eb2b58f57fc595c105ae0a53a851747cddfb7df30f3d7192c837/types-PyYAML-6.0.12.20240311.tar.gz
...
%prep
%setup -q -n types-PyYAML-6.0.12.20240311
cd %{_builddir}/types-PyYAML-6.0.12.20240311
pushd ..
cp -a types-PyYAML-6.0.12.20240311 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710174267
