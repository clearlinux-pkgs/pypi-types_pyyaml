...
Source0  : https://files.pythonhosted.org/packages/d3/47/e1941cf017d2dbf4411f6c8a3932f72eb900572ced7d0ac5d5bab1145357/types-PyYAML-6.0.12.tar.gz
...
%prep
%setup -q -n types-PyYAML-6.0.12
cd %{_builddir}/types-PyYAML-6.0.12
pushd ..
cp -a types-PyYAML-6.0.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664289225
