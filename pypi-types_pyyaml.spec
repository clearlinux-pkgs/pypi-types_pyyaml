...
Source0  : https://files.pythonhosted.org/packages/22/f3/001bdcf302f8ce734d5692611a73ee3dfd3297d36c9f1b7d2fdb7f8589f0/types-PyYAML-6.0.6.tar.gz
...
%prep
%setup -q -n types-PyYAML-6.0.6
cd %{_builddir}/types-PyYAML-6.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650126658
