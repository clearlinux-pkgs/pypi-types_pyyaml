...
Source0  : https://files.pythonhosted.org/packages/38/e5/49cea32633e9425589f913a9fecb47ab3fe363bf1d3c431961842b454b74/types-PyYAML-6.0.12.1.tar.gz
...
%prep
%setup -q -n types-PyYAML-6.0.12.1
cd %{_builddir}/types-PyYAML-6.0.12.1
pushd ..
cp -a types-PyYAML-6.0.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666793500
