...
Source0  : https://files.pythonhosted.org/packages/6e/8f/50d9f23d47e14ede98321802e211456b93ef90b100c39908b7362aa758ff/types-PyYAML-6.0.12.8.tar.gz
...
%prep
%setup -q -n types-PyYAML-6.0.12.8
cd %{_builddir}/types-PyYAML-6.0.12.8
pushd ..
cp -a types-PyYAML-6.0.12.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676998504
