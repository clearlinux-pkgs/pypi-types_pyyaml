...
Source0  : https://files.pythonhosted.org/packages/1f/f9/91b978269698c206d569aca911dc07e5d85101c46873c223e6831c71f168/types-PyYAML-6.0.5.tar.gz
...
%prep
%setup -q -n types-PyYAML-6.0.5
cd %{_builddir}/types-PyYAML-6.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647529179
